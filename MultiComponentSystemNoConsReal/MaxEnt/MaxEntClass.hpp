...
private:
    ...
    /**
     * @brief Class member function to intialise the charge
     * this initialisation uses a (potentially spiked) random uniform distribution
     * 
     * @param charge The charge of one of the components of the system
     * @param norm The normalisation of the component of the system
     */
    void _InitChargeRand(arma::vec&, double&);
     ...
     */
    void _InitChargeSpecific(arma::vec&, double&, int&, int&);
    ...
    */
    ...
    /**
     * @brief Boolean to determine which type of charge initialisation to use
     * 
     */
    bool _initChargeSpecific = false;

    /**
     * @brief Boolean to determine whether to add noise to the specific charge distribution
     * 
     */
    bool _noise = true;

    /**
     * @brief Vector containing the index of the start of the initial charge distributions
     * 
     */
    std::vector<int> _initLayerStart = std::vector<int>(1); 

    /**
     * @brief Real world initLayerStart
     * 
     */
    std::vector<double> _initLayerStartReal = std::vector<double>(1); 

    /**
     * @brief Vector containing the index of the end of the initial charge distributions
     * 
     */
    std::vector<int> _initLayerStop = std::vector<int>(1); 

    /**
     * @brief Real world initLayerStop
     * 
     */
    std::vector<double> _initLayerStopReal = std::vector<double>(1); 
    ...
    /**
     * @brief Boolean stating whether the substrate profile is known
     * 
     */
    bool _knownSubstrate = false;

    /**
     * @brief vector containing substrate profile
     * 
     */
    arma::vec _substrateProfile;
