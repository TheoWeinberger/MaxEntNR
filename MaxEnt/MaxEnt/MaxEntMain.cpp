...
int main()
{
    ...
    arma::mat sldRecon, reflectivityRecon;
    ...
    reflectivityRecon = sldReconstruction.GetReflectivityScaled();


	  sldRecon.save("reconstructedSLD", arma::raw_ascii);
	  reflectivityRecon.save("reconstructedReflectivity", arma::raw_ascii);
